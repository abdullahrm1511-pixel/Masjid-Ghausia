            ...
            {donors.map((donor) => {
              ...
              return (
                <tr className="border-t border-slate-200 align-top hover:bg-sky-50/40" key={donor.id}>
                  ...
                  <td className="p-3">
                    {hasOpenAmount ? (
                      <span className="rounded-md bg-red-50 px-2 py-1 text-xs font-bold text-red-800">Openstaand</span>
                    ) : (
                      <span className="rounded-md bg-teal-50 px-2 py-1 text-xs font-bold text-[#0f5f9f]">Geen openstaand</span>
                    )}
                  </td>
                  <td className="p-3">
