...
export default async function SurveyDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="mx-auto max-w-7xl px-4 py-10">
    ...
    {isOneTime ? <FixedSurveyEditor id={survey.id} templateKey={survey.templateKey} value={survey.questions} /> : <section className="mt-6 rounded-xl border border-sky-200 bg-sky-50 p-5"><h2 className="font-bold text-sky-950">Vaste donateurslogica</h2><p className="mt-1 text-sm text-sky-900">Bestaande donateurs geven zelf hun rekeningnummer en maandbedrag op en hoeven niet te betalen. Nieuwe donateurs doorlopen automatisch de Mollie-machtiging.</p></section>}
