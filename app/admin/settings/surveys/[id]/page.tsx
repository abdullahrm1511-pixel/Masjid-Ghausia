  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div><p className="text-sm font-bold text-[#0f766e]">Enquete beheren</p><h1 className="text-3xl font-bold text-slate-900">{survey.title}</h1><p className="mt-2 text-slate-700">Status: <strong>{surveyStatusLabel(survey)}</strong> · {survey.responses.length} antwoorden</p></div>
        <div className="flex flex-wrap gap-3"><CopySurveyLink url={url} /><a className="rounded-md bg-[#1483d6] px-4 py-3 font-semibold text-white" download href={`/admin/settings/surveys/${survey.id}/qr`}>QR-code downloaden</a></div>
      </div>
