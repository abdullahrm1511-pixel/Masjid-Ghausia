...
const aboutSeo = {
  ...
  description:
    "Informatie over Masjid Ghausia Rotterdam en het St. GBC donateursportaal voor donateurs en inschrijvingen.",
    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <header className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-700">
          Masjid Ghausia is een islamitisch gebedshuis in Rotterdam. Dit subdomein ondersteunt de online donateursadministratie van St. GBC Masjid Ghausia.
        </p>
      </header>

      <section className="mt-6 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-black text-slate-950">Donateursportaal van St. GBC</h2>
